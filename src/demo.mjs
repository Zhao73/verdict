...
export function demoSnapshot() {
  ...
  const s = {
    ...
    technicals: { available: true, return_1m_pct: 6.2, return_3m_pct: 14.8, return_12m_pct: 41.5, momentum_12_1_pct: 33.1, pct_vs_sma50: 4.1, pct_vs_sma200: 17.9, sma50: price / 1.041, sma200: price / 1.179, rsi14: 61.4, realized_vol_30d_pct: 31.2, realized_vol_90d_pct: 28.6, pct_from_52w_high: -6.3, max_drawdown_1y_pct: -22.4, volume_20d_vs_3m: 1.3 },
    series,
    fundamentals: {
